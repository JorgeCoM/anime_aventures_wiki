...
export const SearchComponent = () => {
    return (
        <div className="dropdown dropdown-left">
            ...
            <ul tabIndex={0} className="dropdown-content menu p-2 shadow rounded-box h-12 w-52">
                <form className="absolute top-[-1px]" action="">
                <input placeholder="Type here" className="input input-bordered text-white bg-slate-700 bg w-full max-w-xs" />
