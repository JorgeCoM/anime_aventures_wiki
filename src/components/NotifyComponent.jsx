        ...
        <>
            <div className="dropdown dropdown-end">
                ...
                <ul tabIndex={0} className="dropdown-content menu shadow bg-slate-600 rounded-box h-96 w-[350px]">
                    <li className="flex items-center border-b-2 border-solid flex-row text-white justify-between">
                        <p className="p-2 bg-transparent">Notificaciones</p>
                    <button className="btn p-2 btn-circle btn-ghost">
                    ...
                    <li className="flex p-2">
                        <div className="grid grid-cols-4 mt-2 mb-2">
                            ...
                            <p className="text-white text-sm">Hora de publicacion</p>
                            </div>
